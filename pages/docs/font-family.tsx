...
import { FontFamilyShowcase } from "../../components/docs/font-family/FontFamilyShowcase";
...
export const DocsFontFamilyPage = (props: Props) => {
  return (
    <>
      <Head>
        <title>Font Family | Dashvar Docs</title>
      </Head>
      <Layout>
        <Section>
          <Heading1>Font Family</Heading1>
          <p>
            Dashvar provides a few utility variables for your{" "}
            <code>font-family</code> needs.
          </p>
          <FontFamilyShowcase />
        </Section>
        <Section>
...
export default DocsFontFamilyPage;
